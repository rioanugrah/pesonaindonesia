...
{{-- <li class="navigation-header"><a class="navigation-header-text">Information Technology</a><i class="navigation-header-icon material-icons">more_horiz</i>
</li>
@foreach ($menu as $m)
    @if ($m['sub_menu'] == null)
    <li class="{{ Request::is($m['request']) ? 'active' : '' }} bold"><a class="waves-effect waves-cyan {{ Request::is($m['request']) ? 'active' : '' }} " href="{{route($m['link'])}}"><i class="material-icons">{{ $m['icon'] }}</i><span class="menu-title" data-i18n="{{ $m['link'] }}">{{ $m['title'] }}</span></a>
    </li>
    @else
    <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">{{ $m['sub_menu']['menu']['sub_icon'] }}</i><span class="menu-title" data-i18n="{{ $m['sub_menu']['menu']['sub_title'] }}">{{ $m['sub_menu']['menu']['sub_title'] }}</span></a>
        <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                @foreach ($m['sub_menu'] as $sub_menu)
                <li><a href="media-gallery-page.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Gallery Page">{{ $sub_menu['sub_title'] }}</span></a>
                </li>
                @endforeach
            </ul>
        </div>
...
<li class="{{ Request::is('b/home*') ? 'active' : '' }} bold"><a class="waves-effect waves-cyan {{ Request::is('b/home*') ? 'active' : '' }} " href="{{route('home')}}"><i class="material-icons">home_outline</i><span class="menu-title" data-i18n="Home">Dashboard</span></a>
</li>
<li class="navigation-header"><a class="navigation-header-text">Executive Officer</a><i class="navigation-header-icon material-icons">more_horiz</i>
</li>
<li class="navigation-header"><a class="navigation-header-text">Marketing Officer</a><i class="navigation-header-icon material-icons">more_horiz</i>
</li>
<li class="{{ Request::is('b/wisata*') ? 'active' : '' }} bold"><a class="waves-effect waves-cyan {{ Request::is('b/wisata*') ? 'active' : '' }} " href="{{route('wisata')}}"><i class="material-icons">airplanemode_active</i><span class="menu-title" data-i18n="Wisata">Wisata</span></a>
</li>
<li class="{{ Request::is('b/hotel*') ? 'active' : '' }} bold"><a class="waves-effect waves-cyan {{ Request::is('b/hotel*') ? 'active' : '' }} " href="{{route('hotel')}}"><i class="material-icons">local_hotel</i><span class="menu-title" data-i18n="Hotel">Hotel</span></a>
</li>
...
<li class="{{ Request::is('b/perusahaan*') ? 'active' : '' }} bold"><a class="waves-effect waves-cyan {{ Request::is('b/perusahaan*') ? 'active' : '' }} " href="{{route('perusahaan')}}"><i class="material-icons">business</i><span class="menu-title" data-i18n="Perusahaan">Perusahaan</span></a>
</li>
<li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">photo_filter</i><span class="menu-title" data-i18n="Frontend">Frontend</span></a>
    <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
            <li><a href="{{ route('slider') }}"><i class="material-icons">slideshow</i><span data-i18n="SLider">Slider</span></a>
            </li>
        </ul>
    </div>
</li>
<li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">people_outline</i><span class="menu-title" data-i18n="Akses">Akses</span></a>
    <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
