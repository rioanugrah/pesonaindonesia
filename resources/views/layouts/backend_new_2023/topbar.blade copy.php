        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @endif --}}
                    <span class="badge bg-danger rounded-pill notif-count">{{ auth()->user()->unreadNotifications->count() }}</span>
                </button>
                {{-- <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    <div class="p-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5 class="m-0 font-size-16"> Notifications (<span class="notif-count">0</span>) </h5>
                            </div>
                            <div class="col-auto">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        <div class="dropdown-menu" class="dropdown-notifications">
                            <a href="" data-toggle="dropdown"></a>
                        @foreach(auth()->user()->unreadNotifications as $notification)
                            <a href="" class="text-reset notification-item dropdown-menu" data-toggle="dropdown">
