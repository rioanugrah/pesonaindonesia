<nav class="sidebar">
  <div class="sidebar-header">
    <a href="{{ route('home') }}" class="sidebar-brand" style="font-size: 15px">
      {{-- Pesona Plesiran <span>Indonesia</span> --}}
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item nav-category">Executive Officer</li>
      <li class="nav-item nav-category">Marketing Officer</li>
      <li class="nav-item nav-category">Operational Officer</li>
      <li class="nav-item">
        <a href="{{ route('cooperation') }}" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Kerjasama</span>
        </a>
      </li>
      <li class="nav-item nav-category">Finance Officer</li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="{{ url('/cash_flow') }}" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Cash Flow</span>
        </a>
      </li>
      <li class="nav-item">
        <a href="{{ url('/laporan_keuangan') }}" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Laporan Keuangan</span>
        </a>
      </li>
      <li class="nav-item nav-category">Information Technology</li>
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#frontend" role="button" aria-controls="frontend">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Frontend</span>
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#akses" role="button" aria-controls="akses">
          <i class="link-icon" data-feather="mail"></i>
          <span class="link-title">Akses User</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
      ...
      <li class="nav-item">
        <a href="{{ url('/status') }}" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Persentase Status</span>
        </a>
      </li>
      <li class="nav-item">
