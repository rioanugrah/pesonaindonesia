<header class="tabMobileView header navbar fixed-top d-lg-none">
    <div class="nav-toggle">
        ...
        <a href="{{ route('home') }}" class=""> <img src="{{ asset('backend/assets4/img/logo-3.png') }}" class="img-fluid" alt="logo"></a>
    </div>
    ...
    <ul class="navbar-nav flex-row">
        <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
            <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="{{ asset('backend/assets4/img/ca.svg') }}" alt=""> <span class="d-lg-inline-block d-none"></span>
            </a>
            <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('backend/assets4/img/de.svg') }}" class="flag-width" alt=""> &#xA0;German</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('backend/assets4/img/jp.svg') }}" class="flag-width" alt=""> &#xA0;Japanese</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('backend/assets4/img/fr.svg') }}" class="flag-width" alt=""> &#xA0;French</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('backend/assets4/img/ru.svg') }}" class="flag-width" alt=""> &#xA0;Russian</a>
                <a class="dropdown-item" href="javascript:void(0);"><img src="{{ asset('backend/assets4/img/ca.svg') }}" class="flag-width" alt=""> &#xA0;English</a>
            </div>
        </li>
    </ul>
                ...
                <a class="dropdown-item" href="javascript:void(0);">
                    <div class="media">
                        <div class="usr-img online mr-3">
                            <img class="usr-img rounded-circle" src="{{ asset('backend/assets4/img/90x90.jpg') }}" alt="Generic placeholder image">
                        </div>
