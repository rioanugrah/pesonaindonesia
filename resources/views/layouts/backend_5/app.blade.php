...
<head>
    ...
    <link href="{{ asset('backend/assets4/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backend/assets4/css/plugins.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('backend/assets4/css/support-chat.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backend/assets4/plugins/maps/vector/jvector/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backend/assets4/plugins/charts/chartist/chartist.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('backend/assets4/css/default-dashboard/style.css') }}" rel="stylesheet" type="text/css" />    
    <title>Document</title>
</head>
<body class="default-sidebar">
    @include('layouts.backend_5.header')
    <div class="main-container" id="container">

        <div class="overlay"></div>
        <div class="cs-overlay"></div>
        @include('layouts.backend_5.sidebar')
        <!--  BEGIN CONTENT PART  -->
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="assets/img/90x90.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="img-1" style="border-color: #3862f5;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">1</td>
                                                <td>
                                                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="img-1" style="border-color: #07e0c4;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="img-1" style="border-color: #00b1f4;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="img-1" style="border-color: #f8538d;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">1</td>                                                <td>
                                                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="img-1" style="border-color: #ffbb44;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="img-1" style="border-color: #25d5e4;">
                                                </td>
                                                        ...
                                                        <div class="task-item">
                                                            ...
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <img src="assets/img/90x90.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="assets/img/90x90.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="task-item">
                                                            ...
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <img src="assets/img/90x90.jpg" class="rounded-circle mb-1" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
...
@yield('js')
<script src="{{ asset('backend/assets4/js/libs/jquery-3.1.1.min.js') }}"></script>
<script src="{{ asset('backend/assets4/bootstrap/js/popper.min.js') }}"></script>
<script src="{{ asset('backend/assets4/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/scrollbar/jquery.mCustomScrollbar.concat.min.js') }}"></script>
<script src="{{ asset('backend/assets4/js/app.js') }}"></script>
<script>
    $(document).ready(function() {
        App.init();
    });
</script>
<script src="{{ asset('backend/assets4/js/custom.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/charts/chartist/chartist.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/maps/vector/jvector/jquery-jvectormap-2.0.3.min.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/maps/vector/jvector/worldmap_script/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/calendar/pignose/moment.latest.min.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/calendar/pignose/pignose.calendar.js') }}"></script>
<script src="{{ asset('backend/assets4/plugins/progressbar/progressbar.min.js') }}"></script>
<script src="{{ asset('backend/assets4/js/default-dashboard/default-custom.js') }}"></script>
</html>