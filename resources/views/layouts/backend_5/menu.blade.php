...
<li class="menu">
    ...
    <ul class="collapse submenu list-unstyled" id="marketing" data-parent="#accordionExample">
        <li class="{{ Request::is('b/wisatas*') ? 'active' : '' }}">
            <a href="{{ route('wisata') }}"> Wisata </a>
        </li>
        <li class="{{ Request::is('b/hotel*') ? 'active' : '' }}">
...
<li class="menu">
    <a href="#operating" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        <div class="">
            <i class="flaticon-cart-2"></i>
    ...
    <ul class="collapse submenu list-unstyled" id="operating" data-parent="#accordionExample">
        <li class="{{ Request::is('b/cooperation*') ? 'active' : '' }}">
            <a href="{{ route('cooperation') }}"> Kerjasama </a>
        </li>
        <li class="{{ Request::is('b/events*') ? 'active' : '' }}">
...
<li class="menu">
    <a href="#ti" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        <div class="">
            <i class="flaticon-cart-2"></i>
    ...
    <ul class="collapse submenu list-unstyled" id="ti" data-parent="#accordionExample">
        <li class="{{ Request::is('b/perusahaan*') ? 'active' : '' }}">
        ...
        <li>
            <a href="#ui-buttonss" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Frontend <i class="flaticon-right-arrow"></i> </a>
            <ul class="collapse list-unstyled sub-submenu" id="ui-buttonss" data-parent="#ui-features">
                <li>
