...
@section('content')
    <section class="pb-0 pt-6">
        <div class="container">
            ...
            <p>At Pesona Plesiran Indonesia, accessible from https://plesiranindonesia.com, one of our main priorities is
                the privacy of our visitors. This Privacy Policy document contains types of information that is collected
                and recorded by Pesona Plesiran Indonesia and how we use it.</p>
            ...
            <p>Pesona Plesiran Indonesia follows a standard procedure of using log files. These files log visitors when they
            ...
            <p>Like any other website, Pesona Plesiran Indonesia uses 'cookies'. These cookies are used to store information
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Pesona Plesiran
                Indonesia.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on Pesona Plesiran Indonesia, which are sent
            ...
            <p>Note that Pesona Plesiran Indonesia has no access to or control over these cookies that are used by
                third-party advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>Pesona Plesiran Indonesia's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <p>Pesona Plesiran Indonesia does not knowingly collect any Personal Identifiable Information from children
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in Pesona Plesiran Indonesia. This policy is not
