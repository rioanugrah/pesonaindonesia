                    ...
                    <div class="booking-box">
                        ...
                        <div class="travellers-info mb-4">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="theme2">{{ $order->qty }}</td>
                                        <td class="theme2">{{ \Carbon\Carbon::create($order->created_at)->format('d-m-Y') }}</td>
                                        <td class="theme2">Rp. {{ number_format($order->price,0,",",".") }}</td>
                        ...
                        <div class="travellers-info mb-4">
                            ...
                            <table>
                                ...
                                @foreach ($order_list as $key => $anggota)
                                <tr>
                        ...
                        {{-- <div class="booking-border d-flex"> --}}
                            {{-- <a href="{{ route('invoice.tiket_wisata',['id' => $order->id]) }}" target="_blank" class="nir-btn me-2"><i class="fa fa-print"></i> Invoice</a> --}}
...
<script>
    ...
    //     $.ajax({
    //         type:'POST',
    //         url: "{{ route('frontend.paket.transfer',['id' => $order->id]) }}",
    //         data: formData,
    //         contentType: false,
    //         processData: false,
    //         success: (result) => {
