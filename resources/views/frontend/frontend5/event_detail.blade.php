...
@section('canonical')
    {{ route('frontend.eventDetail',['slug' => $event->slug]) }}
@endsection
...
<div class="page-cover pt-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4">
                <div class="cover-content text-center text-md-start">
                    ...
                    <div class="author-detail d-flex align-items-center">
                        <span class="me-3"><a href="javascript:void()"><i class="fa fa-clock"></i> Post On : {{ \Carbon\Carbon::create($event->created_at)->isoFormat('LL') }}</a></span>
            ...
            <div class="col-lg-6 mb-4">
                <div class="box-shadow p-3 rounded"><img src="{{ asset('frontend/assets4/img/events/'.$event->image) }}" alt="Image" class="w-100 rounded"></div>
            </div>
        </div>
    </div>
</div>
