        ...
        <form class="rlr-banner-search rlr-banner-search--hero-half-mast">
            <div class="rlr-banner-search__input-wrapper">
                ...
                <div
                    ...
                    <div class="rlr-banner-input-group__input-wrapper">
                        <input id="rlr-banner-input-group-activity" name="activity" type="text"
                            autocomplete="off" class="rlr-banner-input-group__input activity_autocomplete"
                            placeholder="Bungee jump" />
                        <i class="rlr-icon-font flaticon-outline-down"> </i>
                        <ul id="autocomplete-results"
                            class="rlr-banner-input-group--activity-dropdown rlr-autocomplete"></ul>
                    </div>
                </div>
                <!-- Date -->
                <div class="rlr-banner-input-group rlr-banner-search__banner-input rlr-js-search-layout-wrapper">
                    ...
                    <div class="rlr-banner-input-group__input-wrapper">
                        ...
                        <ul id="home_date_results" class="rlr-banner-input-group--date-dropdown rlr-autocomplete">
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper rlr-js-product-card-swiper">
                    ...
                    <div class="rlr-section-header">
                        ...
                        <div class="rlr-section__title">
                            <h2 class="rlr-section__title--main">Destinasi</h2>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <article class="rlr-product-card rlr-product-card--v3">
                                ...
                                <figure class="rlr-product-card__image-wrapper">
                                    {{-- <span
                                        class="rlr-badge rlr-badge-- rlr-badge--accent-blue rlr-product-card__badge">
                                        Best Seller </span> --}}
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                                        data-src="{{ asset('plesiran_malang/assets/images/tour/'.$im->images) }}"
                                                        data-srcset="{{ asset('plesiran_malang/assets/images/tour/'.$im->images) }}"
                                                        class="lazyload" alt="{{ $tour->nama_tour }}">
                                                </div>
                                                @endforeach
                                            </div>
                                            <button type="button"
                                                class="btn rlr-button splide__arrow splide__arrow--prev"
                                                aria-label="prev button">
                                                <i class="rlr-icon-font flaticon-left-chevron"> </i>
                                            </button>
                                            <button type="button"
                                                class="btn rlr-button splide__arrow splide__arrow--next"
                                                aria-label="next button">
                                                <i class="rlr-icon-font flaticon-chevron"> </i>
                                            </button>
                                        </div>
                                ...
                                <div class="rlr-product-card__detail-wrapper rlr-js-detail-wrapper">
                                    ...
                                    <div class="rlr-product-card__details">
                                        <div class="rlr-product-card__prices" itemprop="offers" itemscope
                                            ...
                                            <span class="rlr-product-card__price"> <mark
                                                    itemprop="priceCurrency">Rp.</mark><mark
                                                    itemprop="price">{{ number_format($tour->harga,0,',','.') }}</mark> </span>
                                        </div>
                                        {{-- <div class="rlr-product-card__ratings" itemprop="aggregateRating"
                                            ...
                                            <span class="rlr-product-card__rating-text"
                                                itemprop="reviewCount">4.3 (109)</span>
                                        </div> --}}
                                    </div>
                                    <!-- Product card footer -->
                                    <div class="rlr-product-card__footer">
                                        <div class="rlr-icon-text rlr-product-card__icon-text"><i
                                                class="rlr-icon-font flaticon-three-o-clock-clock"> </i> <span
                                                class="">{{ $tour->durasi }} </span></div>
                                        {{-- <ul class="rlr-product-card__icon-text-list">
                                            <li class="rlr-icon-text rlr-product-card__icon-text"><i
                                                    class="rlr-icon-font flaticon-check"> </i> <span
                                                    class="rlr-icon-text__title">New on Emprise </span></li>
                                            <li class="rlr-icon-text rlr-product-card__icon-text"><i
                                                    class="rlr-icon-font flaticon-check"> </i> <span
                                                    class="rlr-icon-text__title">Free Cancellation </span></li>
                                        </ul> --}}
                                    </div>
                                </div>
                            </article>
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                                        ...
                                                        data-srcset="./assets/images/product-images/small/02.jpg"
                                                ...
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                                        ...
                                                        data-srcset="./assets/images/product-images/small/03.jpg"
                                                        class="lazyload" alt="product-image" />
                                                </div>
                                            </div>
                                            <button type="button"
                                ...
                                <div class="rlr-product-card__detail-wrapper rlr-js-detail-wrapper">
                                    ...
                                    <header class="rlr-product-card__header">
                                        <div>
                                            <a href="./product-detail-page.html"
                                                class="rlr-product-card__anchor-title">
                                                <h2 class="rlr-product-card__title" itemprop="name">Circle Line:
                                                    Complete Manhattan Island Cruise</h2>
                                            </a>
                                            <div>
                                                <a href="./product-detail-page.html"
                                    ...
                                    <div class="rlr-product-card__details">
                                        <div class="rlr-product-card__prices" itemprop="offers" itemscope
                                            ...
                                            <span class="rlr-product-card__from">from </span>
                                            <span class="rlr-product-card__price"> <mark
                                                    itemprop="priceCurrency">$</mark><mark
                                                    itemprop="price">795</mark> </span>
                                        </div>
                                        <div class="rlr-product-card__ratings" itemprop="aggregateRating"
                                            itemscope itemtype="https://schema.org/AggregateRating">
                                            <div class="rlr-review-stars" itemprop="ratingValue" itemscope
                        ...
                        <div class="swiper-slide">
                            ...
                            <article class="rlr-product-card rlr-product-card--v3" itemscope
                                ...
                                <!-- Product card image -->
                                <figure class="rlr-product-card__image-wrapper">
                                    <span class="rlr-badge rlr-badge-- rlr-badge--brand rlr-product-card__badge">
                                        Free Lunch </span>
                                    <div class="rlr-product-detail-header__button-wrapper">
                                        <button type="button"
                                            class="btn rlr-button rlr-button--circle rlr-wishlist rlr-wishlist-button--light rlr-wishlist-button rlr-js-action-wishlist"
                                ...
                                <div class="rlr-product-card__detail-wrapper rlr-js-detail-wrapper">
                                    ...
                                    <header class="rlr-product-card__header">
                                        <div>
                                            <a href="./product-detail-page.html"
                                                class="rlr-product-card__anchor-title">
                                                <h2 class="rlr-product-card__title" itemprop="name">Blue Lagoon
                                                    &amp; 3 Islands Half-day Trip from Split</h2>
                                            </a>
                                            <div>
                                                <a href="./product-detail-page.html"
                                                    class="rlr-product-card__anchor-cat">
                                                ...
                                                <a href="./product-detail-page.html"
                                                    class="rlr-product-card__anchor-sub-cat">
                                                    <span class="rlr-product-card__sub-title">Stoke on
                                                        Trent</span>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="rlr-product-card__details">
                                        ...
                                        <div class="rlr-product-card__ratings" itemprop="aggregateRating"
                                            ...
                                            <span class="rlr-product-card__rating-text"
                                                itemprop="reviewCount">5.0 (208)</span>
                                        </div>
                                    </div>
                                    <!-- Product card footer -->
                                    <div class="rlr-product-card__footer">
                        ...
                        <div class="swiper-slide">
                            ...
                            <article class="rlr-product-card rlr-product-card--v3" itemscope
                                ...
                                <figure class="rlr-product-card__image-wrapper">
                                    <span
                                        class="rlr-badge rlr-badge-- rlr-badge--accent-magenta rlr-product-card__badge">
                                        All Access </span>
                                    <div class="rlr-product-detail-header__button-wrapper">
                                        <button type="button"
                                            class="btn rlr-button rlr-button--circle rlr-wishlist rlr-wishlist-button--light rlr-wishlist-button rlr-js-action-wishlist"
                                    ...
                                    <a href="./product-detail-page.html">
                                        <div class="swiper rlr-js-product-multi-image-swiper">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                                        data-src="./assets/images/product-images/small/04.jpg"
                                                        data-srcset="./assets/images/product-images/small/04.jpg"
                                                        class="lazyload" alt="product-image" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                ...
                                <div class="rlr-product-card__detail-wrapper rlr-js-detail-wrapper">
                                    ...
                                    <header class="rlr-product-card__header">
                                        <div>
                                            <a href="./product-detail-page.html"
                                                class="rlr-product-card__anchor-title">
                                                <h2 class="rlr-product-card__title" itemprop="name">Private
                                                    Tour: Montenegro Day Trip from Dubrovnik</h2>
                                            </a>
                                            <div>
                                                <a href="./product-detail-page.html"
                                                    class="rlr-product-card__anchor-cat">
                                    ...
                                    <div class="rlr-product-card__details">
                                        ...
                                        <div class="rlr-product-card__ratings" itemprop="aggregateRating"
                                            ...
                                            <span class="rlr-product-card__rating-text"
                                                itemprop="reviewCount">4.5 (6718)</span>
                                        </div>
                                    </div>
                                    <!-- Product card footer -->
                                    <div class="rlr-product-card__footer">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                                        ...
                                                        data-srcset="./assets/images/product-images/small/01.jpg"
                                                        class="lazyload" alt="product-image" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img itemprop="image" data-sizes="auto"
                                ...
                                <div class="rlr-product-card__detail-wrapper rlr-js-detail-wrapper">
                                    ...
                                    <header class="rlr-product-card__header">
                                        <div>
                                            <a href="./product-detail-page.html"
                                                class="rlr-product-card__anchor-title">
                                                <h2 class="rlr-product-card__title" itemprop="name">Old Town,
                                                    Dubai Creek, Souks, and Street Food Tour</h2>
                                            </a>
                                            <div>
                                                <a href="./product-detail-page.html"
                                                    class="rlr-product-card__anchor-cat">
                                    ...
                                    <div class="rlr-product-card__details">
                                        ...
                                        <div class="rlr-product-card__ratings" itemprop="aggregateRating"
                                            ...
                                            <span class="rlr-product-card__rating-text"
                                                itemprop="reviewCount">4.7 (310)</span>
                                        </div>
                                    </div>
                                    <!-- Product card footer -->
                                    <div class="rlr-product-card__footer">
                        ...
                        <div class="swiper-slide" data-aos="fade-up" data-aos-offset="100"
                                ...
                                <div class="rlr-product-card__detail-wrapper rlr-js-detail-wrapper">
                                    ...
                                    <header class="rlr-product-card__header">
                                        <div>
                                            <a href="./product-detail-page.html"
                                                class="rlr-product-card__anchor-title">
                                                <h2 class="rlr-product-card__title" itemprop="name">Hamilton
                                                    Live! Walking Tour in lower Manhattan</h2>
                                            </a>
                                            <div>
                                                <a href="./product-detail-page.html"
                                                    class="rlr-product-card__anchor-cat">
                                    ...
                                    <div class="rlr-product-card__details">
                                        ...
                                        <div class="rlr-product-card__ratings" itemprop="aggregateRating"
                                            ...
                                            <span class="rlr-product-card__rating-text"
                                                itemprop="reviewCount">4.3 (205)</span>
                                        </div>
                                    </div>
                                    <!-- Product card footer -->
                                    <div class="rlr-product-card__footer">
            ...
            <div class="rlr-masonary-grid__container">
                <div class="rlr-masonary-grid__one">
                    ...
                    <a class="rlr-destination-card" href="javascript:void()">
                        ...
                        <div
                            ...
                            <h2 class="rlr-destination-card__info--main">Balekambang</h2>
                ...
                <div class="rlr-masonary-grid__two">
                    ...
                    <a class="rlr-destination-card" href="javascript:void()">
                        ...
                        <div
                            class="rlr-destination-card__info rlr-destination-card__info--left rlr-destination-card__info--bottom">
                            <h2 class="rlr-destination-card__info--main">Teluk Asmara</h2>
                ...
                <div class="rlr-masonary-grid__three">
                    ...
                    <a class="rlr-destination-card" href="javascript:void()">
                        ...
                        <div
                            class="rlr-destination-card__info rlr-destination-card__info--left rlr-destination-card__info--bottom">
                            <h2 class="rlr-destination-card__info--main">Balai Kota</h2>
                ...
                <div class="rlr-masonary-grid__four">
                    <!-- Destination card -->
                    <a class="rlr-destination-card" href="javascript:void()">
                        <img data-sizes="auto" data-src="{{ $assets }}/assets/images/tour_2.webp"
                            data-srcset="{{ $assets }}/assets/images/tour_2.webp 2x"
                            class="rlr-destination-card__img lazyload" style="filter: brightness(110%);">
                        {{-- <span class="rlr-badge rlr-badge--left rlr-badge-- rlr-badge--abs rlr-badge--abs-dest">
                            406 Tours </span> --}}
                        <div
                            class="rlr-destination-card__info rlr-destination-card__info--left rlr-destination-card__info--bottom">
                            <h2 class="rlr-destination-card__info--main">Alun - Alun Malang</h2>
                ...
                <div class="rlr-masonary-grid__five">
                    ...
                    <a class="rlr-destination-card" href="javascript:void()">
                        ...
                        <div
                            class="rlr-destination-card__info rlr-destination-card__info--left rlr-destination-card__info--bottom">
                            <h2 class="rlr-destination-card__info--main">Bromo</h2>
                ...
                <div class="rlr-masonary-grid__six">
                    ...
                    <a class="rlr-destination-card" href="javascript:void()">
                        ...
                        <div
                            class="rlr-destination-card__info rlr-destination-card__info--left rlr-destination-card__info--bottom">
                            <h2 class="rlr-destination-card__info--main">Kampung Warna - Warni</h2>
            ...
            <div class="rlr-section-header">
                ...
                <div class="button-row">
                    <a href="./search-results--left-sidebar.html"
                        class="btn rlr-button rlr-button--large rlr-button--rounded rlr-button--brand"> Check All
                    </a>
                </div>
            </div>
            <div class="row rlr-featured__cards">
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-offset="250"
                        ...
                        <div class="rlr-product-card--featured__inner">
                            ...
                            <div class="rlr-product-card--featured__body card-img-overlay">
                                ...
                                <div class="rlr-product-detail-header__actions">
                                    <div class="rlr-product-detail-header__button-wrapper">
                                        <button type="button"
                                            class="btn rlr-button rlr-button--circle rlr-wishlist rlr-wishlist-button--no-bg rlr-wishlist-button rlr-js-action-wishlist"
                                            aria-label="Save to Wishlist">
                                            <i class="rlr-icon-font flaticon-heart-1"> </i>
                                        </button>
                                        <span class="rlr-product-detail-header__helptext rlr-js-helptext"></span>
                    ...
                    <div class="rlr-product-card--featured__summary">
                        ...
                        <p class="type-body">Check Out Daily Deals and Promotion on Hotels. Easy &amp; Fast
                            Booking</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-offset="300"
                    data-aos-duration="725">
                    <!-- Featured prodcut card -->
                    <article class="rlr-product-card rlr-product-card--featured" itemscope
                        itemtype="https://schema.org/Product">
                        <!-- Image -->
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-offset="350"
                    ...
                    <div class="slide-track">
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/trivago.png" width="187px" height="64px"
                                alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/tripadvisor.png" width="187px" height="64px"
                                alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/expedia.png" width="187px" height="64px"
                                alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/tailormade.png" width="187px" height="64px"
                                alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/all-inclusive.png" width="187px"
                                height="64px" alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/radisson.png" width="187px" height="64px"
                                alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/disneyland.png" width="187px" height="64px"
                                alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/national-geographic.png" width="187px"
                                height="64px" alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
                                data-src="./assets/images/logos/lonelyplanet.png" width="187px"
                                height="64px" alt="partner logo" />
                        </div>
                        <div class="slide">
                            <img data-sizes="auto" class="lazyload"
    ...
    <section class="rlr-section">
        <div class="container">
            ...
            <div class="rlr-section__title rlr-section__title--centered">
                <h2 class="rlr-section__title--main">Masih ada pertanyaan?</h2>
                {{-- <span class="rlr-section__title--sub">Sost Brilliant reasons Emprise should be your
                    one-stop-shop!</span> --}}
            </div>
            <div class="row">
                <div class="offset-lg-1 col-lg-5" data-aos="fade-down-right" data-aos-duration="700"
                    data-aos-once="true">
                    <div class="rlr-support-card rlr-support-card--sale">
                        <div class="rlr-support-card__content">
                            <div class="rlr-support-card__img-wrapper">
                                <img src="{{ $assets }}/assets/svg/headset.svg" alt="headset" />
                            </div>
                            <h2 class="rlr-support-card__title">For Sales</h2>
                            {{-- <p class="rlr-support-card__subtitle rlr-support-card__text">The Brilliant reasons
                                Emprise be your one-stop-shop!</p> --}}
                            <p class="rlr-support-card__text">sales@plesiranindonesia.com</p>
                            <p class="rlr-support-card__text">0858-6722-4494</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5" data-aos="fade-up" data-aos-duration="800" data-aos-once="true">
                    <div class="rlr-support-card rlr-support-card--help">
                        <div class="rlr-support-card__content">
                            <div class="rlr-support-card__img-wrapper">
                                <img src="{{ $assets }}/assets/svg/help-circle.svg" alt="headset" />
                            </div>
                            <h2 class="rlr-support-card__title">Help &amp; Support</h2>
                            {{-- <p class="rlr-support-card__subtitle rlr-support-card__text">The Brilliant reasons
                                Emprise be your one-stop-shop!</p> --}}
                            <p class="rlr-support-card__text">support@plesiranindonesia.com</p>
                            <p class="rlr-support-card__text">0813-3112-6991</p>
                        </div>
                    </div>
                </div>
            </div>
