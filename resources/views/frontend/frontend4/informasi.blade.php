...
<?php $asset = asset('frontend/assets4/'); ?>
    <div class="container">
        <div class="row">
            <h3 class="text-center">Informasi Umum Kebijakan Perjalanan Selama PPKM</h3>
            ...
            <p>Penumpang berusia di bawah 12 tahun diperbolehkan melakukan perjalanan dengan syarat:</p>
            <ul>
