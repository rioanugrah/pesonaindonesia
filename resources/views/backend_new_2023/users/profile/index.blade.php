                    ...
                    <ul class="activity-feed mb-0 ps-2">
                        <li class="feed-item">
                            <div class="feed-item-list">
                                ...
                                <h5 class="font-size-16">{{ $devices->ip() }}</h5>
                            </div>
                        </li>
                        <li class="feed-item">
                            <div class="feed-item-list">
                                <p class="text-muted mb-1">Devices</p>
                                <h5 class="font-size-16">{{ $devices->device() }}</h5>
                            </div>
                        </li>
                        <li class="feed-item">
                            <div class="feed-item-list">
                                <p class="text-muted mb-1">Useragent</p>
                                <h5 class="font-size-16">{{ $devices->useragent() }}</h5>
                            </div>
                        </li>
                        <li class="feed-item">
                            <div class="feed-item-list">
                                <p class="text-muted mb-1">Operating System</p>
                                <h5 class="font-size-16">{{ $devices->platform() }}</h5>
                            </div>
                        </li>
                    </ul>
                </div>
