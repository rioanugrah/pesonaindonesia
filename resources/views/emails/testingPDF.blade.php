                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_top_head tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo">
                                <img src="{{ public_path('invoice/assets/img/logo_plesiran_new_black.png') }}"
                                    alt="">
                                {{-- <img src="{{ asset('invoice/assets/img/logo_plesiran_new_black.png') }}" alt="Logo"> --}}
                            </div>
                            ...
                            <div class="tm_left_footer">
                                <div class="tm_card_note tm_ternary_bg tm_white_color">
                                    ...
                                    if ($bank[0]->kode_bank == '002') {
                                        $nama_bank = 'BRI';
                                    } elseif ($bank[0]->kode_bank == '009') {
                                        $nama_bank = 'BNI';
                                    } elseif ($bank[0]->kode_bank == '008') {
                                        $nama_bank = 'Mandiri';
                                    }
                                    ?> --}}
                                    <b>Pembayaran: </b>
