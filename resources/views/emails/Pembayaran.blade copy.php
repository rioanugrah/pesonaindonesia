                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    {{-- <tr>
                        <td class="center-text" align="right">
                            <a href="#" Simpli
                                style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:12px;line-height:16px;font-style:normal;font-weight:400;color:#666666;text-decoration:none;letter-spacing:0px;">View
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="center" Simpli bgcolor="#FFFFFF"
                                        style="border-radius:15px 15px 15px 15px; border-bottom:solid 6px #DDDDDD;">
                                        <!-- content -->
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="center">
                                                                            <img style="width:36px;border:0px;display: inline!important;"
                                                                                src="{{ asset('frontend/email/images/Facebook.png') }}"
                                                                                width="36" border="0"
                                                            ...
                                                            {{-- <td class="rwd-on-mobile" align="center" valign="middle"
                                                                ...
                                                                <table border="0" align="center" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="center">
                                                                            <img style="width:36px;border:0px;display: inline!important;"
                                                                                src="{{ asset('frontend/email/images/Twitter.png') }}"
                                                                                width="36" border="0"
                                                                                editable="true" Simpli data-image-edit
                                                                                Simpli alt="icon">
                                                                        </td>
                                ...
                                {{-- <tr>
                                    <td align="center">
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="center-text" Simpli align="center"
                                                    style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:480;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                                    <multiline>
                                                        <div mc:edit Simpli>
                                                            The Simpli App is available for iOS and Android.
                                                        </div>
                                                    </multiline>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <img style="display:block;width:100%;max-width:117px;border:0px;"
                                                                    data-image-edit width="117"
                                                                    src="images/App-Store.png" border="0"
                                                                    editable="true" alt="icon">
                                                            </td>
                                                            <td width="10" style="width: 10px;"></td>
                                                            <td align="center">
                                                                <img style="display:block;width:100%;max-width:117px;border:0px;"
                                                                    data-image-edit width="117"
                                                                    src="images/Google-play.png" border="0"
                                                                    editable="true" alt="icon">
                                                            </td>
                                                        </tr>
                                                    </table>
                                    ...
                                    <td align="center">
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr class="center-on-mobile">
                                                <td Simpli class="rwd-on-mobile center-text" align="center"
                                                    style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                    <a href="#" Simpli
                                                        style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;font-weight:400;line-height:24px;color:#333333;text-decoration:none;">UNSUBSCRIBE</a>
                                                </td>
                                                ...
                                                <td Simpli class="rwd-on-mobile center-text" align="center"
                                                    style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                    <a href="#" Simpli
                                                        style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;font-weight:400;line-height:24px;color:#333333;text-decoration:none;">WEB
                                                        VERSION</a>
                                                </td>
                                                <td class="hide-mobile" align="center" valign="middle">
                                                    <table border="0" align="center" cellpadding="0"
                                                ...
                                                <td Simpli class="rwd-on-mobile center-text" align="center"
                                                    style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                    <a href="#" Simpli
                                                        style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;font-weight:400;line-height:24px;color:#333333;text-decoration:none;">SEND
                                                        TO A FRIEND</a>
                                                </td>
                                            </tr>
                                        </table>
