                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb10">
                        <div class="tm_invoice_info_left">
                            ...
                            <p>
                                <b class="tm_f16 tm_primary_color" style="font-size: 10pt">{{ $details['nama_pembayaran'] }}</b> <br>
                        ...
                        <div class="tm_invoice_info_right">
                            ...
                            <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_accent_bg">
                                <div>
                                    ...
                                    <b class="tm_f16 tm_white_color">Rp. {{ number_format($details['total'],0,",",".") }}</b>
                                </div>
                                <div>
                                    <span class="tm_white_color_60">Invoice Date:</span> <br>
                                    <b class="tm_f16 tm_white_color">{{ \Carbon\Carbon::create($details['created_at'])->isoFormat('LL') }}</b>
                                </div>
                                <div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        @forelse ($details['order_details'] as $row => $order_detail)
                                            ...
                                            @if ($row == 0)
                                                <td class="tm_width_7">
                                                    <p class="tm_m0 tm_f16 tm_primary_color" style="font-size:10pt">{{ $details['nama_order'].' - '.$details['nama_pembayaran'] }}</p>
                                                </td>
                            ...
                            <div class="tm_left_footer">
                                <div class="tm_card_note tm_ternary_bg tm_white_color">
                                    <?php 
                                        if ($details['bank'] == '002') {
                                            $nama_bank = 'BRI';
                                        }else if($details['bank'] == '009'){
                                            $nama_bank = 'BNI';
                                        }else if($details['bank'] == '008'){
                                            $nama_bank = 'Mandiri';
                                        }
                                    ?>
                    ...
                    <div class="tm_note tm_font_style_normal tm_text_center">
                        ...
                        <p class="tm_m0" style="font-style: italic">Terakhir diupdate {{ \Carbon\Carbon::parse($details['updated_at'])->isoFormat('LLL') }}</p>
                    </div><!-- .tm_note -->
                </div>
            </div>
