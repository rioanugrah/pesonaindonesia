                        ...
                        <div class="tm_invoice_info_left">
                            ...
                            <p>
                                <b class="tm_f16 tm_primary_color"
                                    style="font-size: 10pt">{{ $transaction_detail->first_name . ' ' . $transaction_detail->last_name }}</b>
                                <br>
                        ...
                        <div class="tm_invoice_info_right">
                            ...
                            <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_accent_bg">
                                ...
                                <div>
                                    ...
                                    <b class="tm_f16 tm_white_color">{{ \Carbon\Carbon::create($invoice->created_at)->isoFormat('LL') }}
                                    </b>
                                </div>
                                <div>
