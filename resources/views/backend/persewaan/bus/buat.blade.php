...
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <div class="card">
            <form action="{{ route('persewaan.bus.simpan') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_barang" placeholder="Nama Persewaan">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                                    ...
                                                    <div data-repeater-list="armada" class="inner mb-3">
                                                        ...
                                                        <div data-repeater-item class="inner mb-3 row">
                                                            <div class="col-md-10 col-sm-8">
                                                                <input type="text" name="armada" class="inner form-control"
                                                    ...
                                                    <div data-repeater-list="spesifikasi" class="inner mb-3">
                                                        ...
                                                        <div data-repeater-item class="inner mb-3 row">
                                                            <div class="col-md-10 col-sm-8">
                                                                ...
                                                                <input type="text" name="spesifikasi" class="inner form-control"
                                            ...
                                            <div data-repeater-item class="outer">
                                                <div class="inner-repeater mb-4">
                                                    <div data-repeater-list="harga" class="inner mb-3">
                                                        ...
                                                        <div data-repeater-item class="inner mb-3 row">
                                                            <div class="col-md-10 col-sm-8">
                                                                <input type="text" name="deskripsi" class="inner form-control"
                                                                    placeholder="Deskripsi Harga...">
                                                                <input type="text" name="harga" class="inner form-control"
                                                                    placeholder="Harga...">
                                                                <select name="satuan" class="inner form-control" id="">
                                                                    <option>-- Pilih Satuan --</option>
                                                                    <option value="Hari">Hari</option>
                                                                    <option value="12 Jam">12 Jam</option>
                                                                    <option value="18 Jam">18 Jam</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-2 col-sm-4">
                                                                <div class="d-grid">
