        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="edit_provinsi" class="form-control provinsi" id="provinsi">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="edit_kota_kabupaten" class="form-control kota_kabupaten" id="kota_kabupaten">
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="edit_kecamatan" class="form-control kecamatan" id="kecamatan">
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
