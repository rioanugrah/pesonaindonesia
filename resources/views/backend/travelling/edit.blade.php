...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
            <div class="card">
                <form method="post" action="{{ route('travelling.update', ['id' => $travelling->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_travelling"
                                        value="{{ $travelling->nama_travelling }}" placeholder="Nama Paket">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="kategori_paket_id" class="form-control" id="">
                                        ...
                                        <option value="1"
                                            {{ $travelling->kategori_paket_id == 1 ? 'selected' : null }}>Private</option>
                                        <option value="2"
                                            {{ $travelling->kategori_paket_id == 2 ? 'selected' : null }}>Publik</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="meeting_point"
                                        value="{{ $travelling->meeting_point }}" placeholder="Meeting Point">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                                                ...
                                                <div data-repeater-list="highlight" class="inner mb-3">
                                                    ...
                                                    <div data-repeater-item class="inner mb-3 row">
                                                        <div class="col-md-10 col-sm-8">
                                                            <input type="text" name="nama_highlight"
                                                                class="inner form-control" placeholder="Highlight..."
                                                                value="{{ $travelling_highlight->nama_highlight }}">
                                                        </div>
                                                        <div class="col-md-2 col-sm-4">
                                                            <div class="d-grid">
                                                                <button data-repeater-delete type="button"
                                                                    class="btn btn-danger inner"><i
                                                    ...
                                                    <div data-repeater-item class="inner mb-3 row">
                                                        <div class="col-md-10 col-sm-8">
                                                            ...
                                                            <input type="text" name="nama_fasilitas"
                                                                class="inner form-control" placeholder="Fasilitas..."
                                                                value="{{ $tf->nama_fasilitas }}">
                                                        </div>
                                                        <div class="col-md-2 col-sm-4">
                                                            <div class="d-grid">
                                                                <button data-repeater-delete type="button"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="contact_person"
                                        placeholder="Contact Person" value="{{ $travelling->contact_person }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" name="tanggal_rilis"
                                        value="{{ $travelling->tanggal_rilis }}">
                                </div>
                            </div>
