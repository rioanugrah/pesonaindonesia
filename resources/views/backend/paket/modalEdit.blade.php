<div class="modal fade" id="edit" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" id="edit_upload-form1" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="edit_nama_paket" placeholder="Nama Paket" id="edit_nama_paket">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Kategori Paket</label>
                        <select name="edit_kategori_paket_id" class="form-control" id="edit_kategori_paket_id">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="edit_deskripsi" class="form-control" cols="30" rows="10" id="edit_deskripsi"></textarea>
