...
@section('content')
@include('backend.coupons.modalBuat')
    ...
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active" aria-current="Coupon">Coupon</li>
            </ol>
        </div>
        <div class="col-md-4">
...
<script>
    var table = $('#datatable').DataTable({
        ...
        columns: [
            ...
            {
                data: 'coupons_discount',
                name: 'coupons_discount'
            },
            {
                data: 'coupons_description',
                name: 'coupons_description'
            },
            {
                data: 'coupons_limit',
                name: 'coupons_limit'
            ...
            {
                data: 'coupons_expired',
                name: 'coupons_expired'
            },
            {
                data: 'coupons_images',
                name: 'coupons_images'
