...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#add1').click(function(){  
                i++;  
                $('#dynamic_field_fasilitas').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="fasilitas[]" placeholder="Fasilitas" class="form-control fasilitas_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_fasilitas"><span class="fa fa-times"></span></button></td></tr>');  
            }); 

            $('#add2').click(function(){  
                i++;  
                $('#dynamic_field_timeline').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="waktu[]" class="form-control" placeholder="Pukul"></td><td><input type="text" name="timeline[]" placeholder="Rencana Perjalanan '+i+'" class="form-control timeline_list"></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_timeline"><span class="fa fa-times"></span></button></td></tr>');  
            }); 

            $(document).on('click', '.btn_remove_fasilitas', function(){  
