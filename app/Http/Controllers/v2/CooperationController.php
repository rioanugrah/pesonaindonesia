...
class CooperationController extends Controller
{
    public function index(Request $request)
    {
        ...
        // dd($data);
        return view('backend_new_2023.cooperation.index', $data);
    }
    ...
    public function simpan(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if($request->file('logo_perusahaan')){
                ...
                $img->save(public_path('backend_2023/berkas/coorporate/').$input['logo_perusahaan']);
            }
    ...
    public function hapus($id)
    {
        ...
        if(auth()->user()->role == 1){
            if($cooperations){
                $cooperations->delete();
                if(File::exists(public_path('backend_2023/berkas/coorporate/'.$cooperations->berkas))){
                    File::delete(public_path('backend_2023/berkas/coorporate/'.$cooperations->berkas));
                }
        ...
        if($validator->passes()){
            if(auth()->user()->role != 1){
                ...
                elseif($cooperation->status == 1){
                    ...
                    $file->move(public_path('backend_2023/berkas/coorporate'), $fileName);
                    $image_path = public_path('backend_2023/berkas/coorporate/'.$cooperation->berkas);
                    File::delete($image_path);
    ...
    public function berkas(Request $request)
    {
        ...
        if($validator->passes()){
            if(auth()->user()->role != 1){
                ...
                $fileName = $cooperation->nama_perusahaan.$file->getClientOriginalName();
                $file->move(public_path('backend_2023/berkas/coorporate'), $fileName);
                $image_path = public_path('backend_2023/berkas/coorporate');
                File::delete($image_path);
    ...
    public function download($id)
    {
        ...
        if(auth()->user()->role != 1){
            ...
            if($data['cooperation']['berkas'] == null){
                ...
                return redirect(asset('backend_2023/berkas/coorporate/'.$data['cooperation']['berkas']));
    ...
    public function surat($id)
    {
        ...
        $surat = PDF::loadview('backend_new_2023.cooperation.surat_perjanjian_kerjasama',$data)
                    // ->allow('AllFeatures')
